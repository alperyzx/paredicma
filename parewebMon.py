...
css_style = """
    <style>
        ...
        html[data-theme="light"] .cluster-info-table th { background-color: #f2f2f2 !important; color: #333 !important; }
        html[data-theme="light"] .cluster-info-table tbody tr { background-color: #ffffff !important; color: #333 !important; }
        html[data-theme="light"] .cluster-info-table tbody tr:nth-child(even) { background-color: #f9f9f9 !important; }
        html[data-theme="light"] .cluster-info-table tbody tr:hover { background-color: #f0f0f0 !important; }
        html[data-theme="light"] .cluster-info-table td { color: #333 !important; border-color: #ddd !important; }
    ...
    <body>
        <div class="welcome-container">
            ...
            <div class="welcome-footer" style="margin-top: 40px; text-align: center; color: #777;">
                ...
                <p style="font-size: 12px;">Paredicma v3.0 - Redis Cluster Management Tool</p>
            </div>
        </div>
    </body>
    </html>
